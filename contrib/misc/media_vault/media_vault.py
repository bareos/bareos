        ...
        if self.iron_acct:
            ...
            try:
                ...
                ctime = datetime.datetime.fromtimestamp(
                    f_stats.st_ctime,datetime.timezone.utc).strftime('%Y-%m-%dT%H:%M:%S.%f%z')
                atime = datetime.datetime.fromtimestamp(
                    f_stats.st_atime,datetime.timezone.utc).strftime('%Y-%m-%dT%H:%M:%S.%f%z')
                mtime = datetime.datetime.fromtimestamp(
                    f_stats.st_mtime,datetime.timezone.utc).strftime('%Y-%m-%dT%H:%M:%S.%f%z')
                t_stat = (
                            f"{'----------' : <10} {' ' : <15}\n"
