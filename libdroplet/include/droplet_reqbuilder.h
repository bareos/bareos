...
dpl_status_t dpl_req_set_access_key(dpl_req_t *req, char *access_key);
...
dpl_status_t dpl_add_date_to_headers(dpl_dict_t *headers);
dpl_status_t dpl_add_authorization_to_headers(dpl_req_t *req, dpl_dict_t *headers);
