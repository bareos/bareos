...
dpl_req_t *create_req_for_test(dpl_ctx_t *, dpl_method_t, const char *, const char *, dpl_dict_t **);
...
START_TEST(s3_auth_headers_test1)
{
  ...
  req = create_req_for_test(ctx, DPL_METHOD_GET, "johnsmith", "/photos/puppy.jpg", &headers);
...

  {
    ...
    strftime(date_str, sizeof(date_str), "%a, %d %b %Y %H:%M:%S +0000", &test_date);
  ...
  dpl_assert_str_eq(authorization, "AWS AKIAIOSFODNN7EXAMPLE:bWq2s1WEIj+Ydj0vQ697zp+IXMU=");
...
START_TEST(s3_auth_headers_test2)
{
  ...
  ctx = create_ctx_for_test(2);
  req = create_req_for_test(ctx, DPL_METHOD_PUT, "johnsmith", "/photos/puppy.jpg", &headers);
  ...
  authorization = dpl_sbuf_get_str(var->val->string);
  dpl_assert_str_eq(authorization, "AWS AKIAIOSFODNN7EXAMPLE:MyyxeRY7whkBe+bq8fHCL/2kKUg=");
...
START_TEST(s3_auth_headers_test3)
{
  ...
  authorization = dpl_sbuf_get_str(var->val->string);
  dpl_assert_str_eq(authorization, "AWS AKIAIOSFODNN7EXAMPLE:htDYFYduRNen8P9ZfE/s9SuKy0U=");
...
START_TEST(s3_auth_headers_test4)
{
  ...
  authorization = dpl_sbuf_get_str(var->val->string);
  dpl_assert_str_eq(authorization, "AWS AKIAIOSFODNN7EXAMPLE:c2WLPFtWHVgbEmeEG93a4cG37dM=");
...
START_TEST(s3_auth_headers_test5)
{
  ...
  ctx = create_ctx_for_test(2);
  req = create_req_for_test(ctx, DPL_METHOD_DELETE, "johnsmith", "/photos/puppy.jpg", &headers);

  {
    ...
    ret = dpl_dict_add(headers, "x-amz-date", "Tue, 27 Mar 2007 21:20:26 +0000", 0);
    dpl_assert_int_eq(DPL_SUCCESS, ret);
  }
  ...
  authorization = dpl_sbuf_get_str(var->val->string);
  dpl_assert_str_eq(authorization, "AWS AKIAIOSFODNN7EXAMPLE:lx3byBScXR6KzyMaifNkardMwNk=");
...
START_TEST(s3_auth_headers_test6)
{
  ...
  ctx = create_ctx_for_test(2);
  req = create_req_for_test(ctx, DPL_METHOD_PUT, "johnsmith", "/db-backup.dat.gz", &headers);

  {
    ...
    ret = dpl_dict_add(headers, "X-Amz-Meta-ReviewedBy", "joe@johnsmith.net,jane@johnsmith.net", 0);
    dpl_assert_int_eq(DPL_SUCCESS, ret);
    ...
    ret = dpl_dict_add(headers, "Content-Disposition", "attachment; filename=database.dat", 0);
    dpl_assert_int_eq(DPL_SUCCESS, ret);
  ...
  authorization = dpl_sbuf_get_str(var->val->string);
  dpl_assert_str_eq(authorization, "AWS AKIAIOSFODNN7EXAMPLE:ilyl83RwaSoYIEdixDQcA4OnAnc=");
...
START_TEST(s3_auth_headers_test7)
{
  ...
  authorization = dpl_sbuf_get_str(var->val->string);
  dpl_assert_str_eq(authorization, "AWS AKIAIOSFODNN7EXAMPLE:qGdzdERIC03wnaRNKh6OqZehG9s=");
...
START_TEST(s3_auth_headers_test8)
{
  ...
  ctx = create_ctx_for_test(2);
  req = create_req_for_test(ctx, DPL_METHOD_GET, NULL, "/dictionary/fran%C3%A7ais/pr%c3%a9f%c3%a8re", &headers);
  ...
  authorization = dpl_sbuf_get_str(var->val->string);
  dpl_assert_str_eq(authorization, "AWS AKIAIOSFODNN7EXAMPLE:DNEZGsoieTZ92F3bUfSPQcbGmlM=");
...
START_TEST(s3_auth_params_test1)
{
  ...
  dpl_assert_ptr_not_null(var);
  dpl_assert_str_eq(dpl_sbuf_get_str(var->val->string), "NpgCjnDzrM%2BWFzoENXmpNDUsSn8%3D");
