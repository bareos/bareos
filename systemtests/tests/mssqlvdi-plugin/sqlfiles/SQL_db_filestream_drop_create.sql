...
CREATE DATABASE [$(myDB)]
 CONTAINMENT = NONE
 ON  PRIMARY
( NAME = N'$(myDB)', FILENAME = N'C:\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\$(myDB).mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ),
 FILEGROUP [FileGroup1] CONTAINS FILESTREAM  DEFAULT
( NAME = N'$(myDB)Attachment', FILENAME = N'C:\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\$(myDB)Attachment' , MAXSIZE = UNLIMITED)
 LOG ON
( NAME = N'$(myDB)_log', FILENAME = N'C:\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\$(myDB)_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [$(myDB)] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF, DIRECTORY_NAME = N'Filestream$(myDB)' )
GO
