...
Build-Depends: acl-dev, bc, chrpath, debhelper (>= 7.0.50~), dpkg-dev (>= 1.13.19), git-core, libacl1-dev, libcap-dev, libfastlz-dev, libjansson-dev, libjson-c-dev, liblzo2-dev, qtbase5-dev, libreadline-dev, libssl-dev, libwrap0-dev, libx11-dev, libxml2-dev, libsqlite3-dev, default-libmysqlclient-dev | libmysqlclient-dev, libpq-dev, logrotate, lsb-release, mtx, ncurses-dev, openssl, pkg-config, po-debconf (>= 0.8.2), python-dev, zlib1g-dev, postgresql-server-dev-all, cmake, libpam-dev
