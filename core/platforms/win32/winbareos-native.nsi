...
Name "${PRODUCT_NAME} ${PRODUCT_VERSION} (${PRODUCT_PLATFORM}) ${ENABLE_SUBSCRIPTION_FEATURES}"
OutFile "${PRODUCT_NAME}-${PRODUCT_VERSION}-${PRODUCT_PLATFORM}-${CMAKE_CONFIG_TYPE}-${ENABLE_SUBSCRIPTION_FEATURES}-unsigned.exe"
