...
var SUBSCRIPION_FEATURES_TEXT
StrCmp ${ENABLE_SUBSCRIPTION_FEATURES} "1" 0 +3
StrCpy $SUBSCRIPTION_FEATURES_TEXT "subscription"
Goto +2
StrCpy $SUBSCRIPION_FEATURES_TEXT "community"
