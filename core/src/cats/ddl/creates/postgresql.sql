...
(
    ...
    AverageTransferRate BIGINT      DEFAULT 0,
    LastTransferRate    BIGINT      DEFAULT 0,
    LastCheckpointTime  TIMESTAMP   WITHOUT TIME ZONE,
    LastCheckpointFiles INTEGER     DEFAULT 0,
    LastFileProcessed   TEXT,
    Comment             TEXT,
    PRIMARY KEY (JobId)
);
