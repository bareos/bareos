...
static ResourceItem cli_items[] = {
  ...
  {"FdPort", CFG_TYPE_ADDRESSES_PORT, ITEM(res_client, FDaddrs), 0, 0, FD_DEFAULT_PORT, NULL, NULL},
  {"FdAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_client, FDaddrs), 0, 0, FD_DEFAULT_PORT, NULL, NULL},
  {"FdAddresses", CFG_TYPE_ADDRESSES, ITEM(res_client, FDaddrs), 0, 0, FD_DEFAULT_PORT, NULL, NULL},
  {"FdSourceAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_client, FDsrc_addr), 0, 0, "0", NULL, NULL},
  ...
  {"SdConnectTimeout", CFG_TYPE_TIME, ITEM(res_client, SDConnectTimeout), 0, 0, "1800" /* 30 minutes */, NULL, NULL},
  ...
  {"PkiSignatures", CFG_TYPE_BOOL, ITEM(res_client, pki_sign), 0, 0, "false", NULL, "Enable Data Signing."},
  {"PkiEncryption", CFG_TYPE_BOOL, ITEM(res_client, pki_encrypt), 0, 0, "false", NULL, "Enable Data Encryption."},
  ...
  {"PkiCipher", CFG_TYPE_CIPHER, ITEM(res_client, pki_cipher), 0, 0, "aes128", NULL,
  ...
  {"AllowBandwidthBursting", CFG_TYPE_BOOL, ITEM(res_client, allow_bw_bursting), 0, 0, "false", NULL, NULL},
  ...
  {"LogTimestampFormat", CFG_TYPE_STR, ITEM(res_client, log_timestamp_format), 0, 0, "%d-%b %H:%M", "15.2.3-", NULL},
  {"GrpcModule", CFG_TYPE_STDSTR, ITEM(res_client, grpc_module), 0, 0, "bareos-grpc-fd-plugin-bridge",
   "25.0.0-", "The grpc module to use for grpc fallback."},
  {"EnableKtls", CFG_TYPE_BOOL, ITEM(res_client, enable_ktls), 0, 0, "false", "23.0.0-", "If set to \"yes\", Bareos will allow the SSL implementation to use Kernel TLS."},
...
static ResourceItem dir_items[] = {
  ...
  {"Port", CFG_TYPE_PINT32, ITEM(res_dir, port), 0, 0, DIR_DEFAULT_PORT, "16.2.2",
      "Director Network Port. Only used if \"Connection From Client To Director\" is enabled."},
  {"ConnectionFromDirectorToClient", CFG_TYPE_BOOL, ITEM(res_dir, conn_from_dir_to_fd), 0, 0,
      "true", "16.2.2", "This Client will accept incoming network connection from this Director."},
  {"ConnectionFromClientToDirector", CFG_TYPE_BOOL, ITEM(res_dir, conn_from_fd_to_dir), 0, 0,
      "false", "16.2.2", "Let the Filedaemon initiate network connections to the Director."},
  {"Monitor", CFG_TYPE_BOOL, ITEM(res_dir, monitor), 0, 0, "false", NULL, NULL},
