...
static ResourceItem cli_items[] = {
  ...
  {"Port", CFG_TYPE_ADDRESSES_PORT, ITEM(res_client, FDaddrs), 0, CFG_ITEM_DEFAULT, FD_DEFAULT_PORT, NULL, NULL, { "FdPort" }},
  {"Address", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_client, FDaddrs), 0, CFG_ITEM_DEFAULT, FD_DEFAULT_PORT, NULL, NULL, { "FdAddress" }},
  {"Addresses", CFG_TYPE_ADDRESSES, ITEM(res_client, FDaddrs), 0, CFG_ITEM_DEFAULT, FD_DEFAULT_PORT, NULL, NULL, { "FdAddresses" }},
  {"SourceAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_client, FDsrc_addr), 0, CFG_ITEM_DEFAULT, "0", NULL, NULL, { "FdSourceAddress" }},
