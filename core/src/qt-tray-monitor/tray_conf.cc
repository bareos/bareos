...
static ResourceItem dir_items[] = {
    ...
    {"EnableSsl", CFG_TYPE_BOOL, ITEM(res_dir.enable_ssl), 0, CFG_ITEM_DEFAULT, "true", NULL, NULL},
...
static ResourceItem cli_items[] = {
    ...
    {"EnableSsl", CFG_TYPE_BOOL, ITEM(res_client.enable_ssl), 0, CFG_ITEM_DEFAULT, "true", NULL, NULL},
...
static ResourceItem store_items[] = {
    ...
    {"EnableSsl", CFG_TYPE_BOOL, ITEM(res_store.enable_ssl), 0, CFG_ITEM_DEFAULT, "true", NULL, NULL},
