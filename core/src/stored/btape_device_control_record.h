...
#ifndef BAREOS_STORED_BTAPE_DEVICE_CONTROL_RECORD_H_
#define BAREOS_STORED_BTAPE_DEVICE_CONTROL_RECORD_H_
...
#endif  // BAREOS_STORED_BTAPE_DEVICE_CONTROL_RECORD_H_
