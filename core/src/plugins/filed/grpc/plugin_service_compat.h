...
#ifndef BAREOS_PLUGINS_FILED_GRPC_PLUGIN_SERVICE_COMPAT_H_
#define BAREOS_PLUGINS_FILED_GRPC_PLUGIN_SERVICE_COMPAT_H_
...
#endif  // BAREOS_PLUGINS_FILED_GRPC_PLUGIN_SERVICE_COMPAT_H_
