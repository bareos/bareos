...
/*                              bEvent* event, */
/*                              void* value); */
/* static bRC startBackupFile(bpContext* bareos_plugin_ctx, struct save_pkt*
 * sp); */
...
/*                pFuncs** pfuncs) */
/* { */
/*   bfuncs = lbfuncs; /1* Set Bareos funct pointers *1/ */
/*   binfo = lbinfo; */
...
/*     void* ctx_from_bareosfd_module = PyCapsule_Import("bareosfd.bpContext",
 * 0); */
...
/*     void* bfuncs_from_bareosfd_module = PyCapsule_Import("bareosfd.bFuncs",
 * 0); */
