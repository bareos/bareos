...
/*                              bEvent* event, */
/*                              void* value); */
/* static bRC startBackupFile(bplugin_private_context* bareos_plugin_ctx, struct
 * save_pkt* sp); */
/* static bRC endBackupFile(bplugin_private_context* bareos_plugin_ctx); */
/* static bRC pluginIO(bplugin_private_context* bareos_plugin_ctx, struct
 * io_pkt* io); */
/* static bRC startRestoreFile(bplugin_private_context* bareos_plugin_ctx, const
 * char* cmd);
 */
/* static bRC endRestoreFile(bplugin_private_context* bareos_plugin_ctx); */
/* static bRC createFile(bplugin_private_context* bareos_plugin_ctx, struct
 * restore_pkt* rp);
 */
/* static bRC setFileAttributes(bplugin_private_context* bareos_plugin_ctx, */
/*                              struct restore_pkt* rp); */
/* static bRC checkFile(bplugin_private_context* bareos_plugin_ctx, char*
 * fname); */
 ...
 */
/* static bRC getXattr(bplugin_private_context* bareos_plugin_ctx, xattr_pkt*
 * xp); */
/* static bRC setXattr(bplugin_private_context* bareos_plugin_ctx, xattr_pkt*
 * xp); */
/* static bRC parse_plugin_definition(bplugin_private_context*
 * bareos_plugin_ctx, */
/*                                    void* value, */
