...
#ifndef BAREOS_CORE_SRC_PLUGINS_DIRD_PYTHON_PLUGIN_PRIVATE_CONTEXT_H_
#define BAREOS_CORE_SRC_PLUGINS_DIRD_PYTHON_PLUGIN_PRIVATE_CONTEXT_H_
/**
...
#endif  // BAREOS_CORE_SRC_PLUGINS_DIRD_PYTHON_PLUGIN_PRIVATE_CONTEXT_H_
