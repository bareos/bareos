    ...
    case E_ACCESSDENIED:
      errmsg
          = "The caller does not have sufficient backup privileges or is not "
            ...
            "administrator.";
      break;
    case static_cast<long int>(VSS_E_INVALID_XML_DOCUMENT):
      errmsg = "The XML document is not valid.";
      break;
    case static_cast<long int>(VSS_E_OBJECT_NOT_FOUND):
      errmsg = "The specified file does not exist.";
      break;
    case static_cast<long int>(VSS_E_BAD_STATE):
      errmsg
          = "Object is not initialized; called during restore or not called in "
            "correct sequence.";
      break;
    case static_cast<long int>(VSS_E_WRITER_INFRASTRUCTURE):
      errmsg
