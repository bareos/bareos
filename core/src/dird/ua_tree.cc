 ...
 */
int InsertTreeHandler(void* ctx, [[maybe_unused]] int num_fields, char** row)
{
  struct stat statp;
...
static int DotHelpcmd(UaContext* ua, [[maybe_unused]] TreeContext* tree)
{
...
static int HelpCmd(UaContext* ua, [[maybe_unused]] TreeContext* tree)
{
  unsigned int i;
...
static int donecmd([[maybe_unused]] UaContext* ua,
                   [[maybe_unused]] TreeContext* tree)
{
  return 0;
}

static int QuitCmd(UaContext* ua, [[maybe_unused]] TreeContext* tree)
{
  ua->quit = true;
  return 0;
}
