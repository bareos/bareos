...
class UaContext {
 ...
 public:
  ...
  void SendMsg(const char* fmt, ...) __attribute__((format(printf, 2, 3)));
  void ErrorMsg(const char* fmt, ...) __attribute__((format(printf, 2, 3)));
  void WarningMsg(const char* fmt, ...) __attribute__((format(printf, 2, 3)));
  void InfoMsg(const char* fmt, ...) __attribute__((format(printf, 2, 3)));
  void SendCmdUsage(const char* fmt, ...) __attribute__((format(printf, 2, 3)));
