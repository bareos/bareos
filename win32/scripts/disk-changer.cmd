...
REM
REM
REM Bareos interface to virtual autoloader using disk storage
REM
REM  $Id$
REM
...
REM
REM  So Bareos will always call with all the following arguments, even though
...
REM  C:\Temp\bareos\drive0  Note: you must not have a trailing slash, and
...
REM
REM  Full example: disk-changer C:\Temp\bareos\conf load 1 C:\Temp\bareos\drive0 0
REM
REM The Volumes will be created with names slot1, slot2, slot3, ... maxslot in the
REM  base directory. In the above example the base directory is C:\Temp\bareos.
REM  However, as with tapes, their Bareos Volume names will be stored inside the
REM  Volume label. In addition to the Volumes (e.g. C:\Temp\bareos\slot1,
REM  C:\Temp\bareos\slot3, ...) this script will create a C:\Temp\bareos\loadedn
