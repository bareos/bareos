...
const WIDGETS = [
  ...
  {
    type: 'catalog-status',
    label: 'Catalog Table Sizes',
    description: 'Catalog size and per-table size breakdown.',
    icon: 'mdi-database',
    component: defineAsyncComponent(() => import('./widgets/CatalogStatusWidget.vue')),
    defaultTitle: 'Catalog Table Sizes',
  ...
  },
  {
    ...
    icon: 'mdi-sigma',
    component: defineAsyncComponent(() => import('./widgets/AnalyticsWidgets.vue')),
    defaultTitle: 'Job Summary',
  ...
  },
  {
    ...
    label: 'Stored Data per Client',
    description: 'Stored data totals grouped by client.',
    icon: 'mdi-chart-tree',
    component: defineAsyncComponent(() => import('./widgets/AnalyticsWidgets.vue')),
    defaultTitle: 'Stored Data per Client',
    defaultLayout: { w: 8, h: 10 },
    requiredProps: [],
    optionalProps: [],
  },
