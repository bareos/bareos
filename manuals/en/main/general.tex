...
\index[general]{Bareos!What is }
\index[general]{What is Bareos? }
...
\index[general]{Who Needs Bareos? }
\index[general]{Bareos!Who Needs }
...
\index[general]{Services!Bareos Components or }

Bareos is made up of the following five major components or services:
Director, Console, File, Storage, and Monitor services.


%\addcontentsline{lof}{figure}{Bareos Applications}
%\includegraphics{\idir bareos-applications.eps}
...
\subsection*{Bareos Director}
   ...
   Document in the Bareos Developer's Guide.  The Director runs as a daemon
...
\subsection*{Bareos Storage}
   ...
   Document in the Bareos Developer's Guide.  The Storage services runs as
...
\index[general]{What Bareos is Not}
...
\index[general]{Interactions Between the Bareos Services}
\index[general]{Services!Interactions Between the Bareos}
