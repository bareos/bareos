...
\xdirective{dir}{Password}{password}{required}{}{}{%
...
\xdirective{dir}{Absolute Job Timeout}{time}{}{}{14.2}{%
}

\xdirective{dir}{Auditing}{yes{\textbar}no}{}{no}{14.2}{%
\label{DirectorConfigDirectorAuditing}%
...
The \ilink{messages resource}{MessagesResource} configured in \configdirective{Messages} 
defines, how these messages are handled.
}

\xdirective{dir}{Audit Events}{list}{}{}{14.2}{%
}


\xdirective{dir}{Backend Directory}{directory}{}{{\it platform specific}}{}{%
This directive specifies a directory from where the Bareos Director loads his dynamic backends.
}


\xdirective{dir}{Description}{text}{}{}{}{%
...
\xdirective{dir}{Dir Address}{IP-address}{}{}{}{%
...
default).  Note, unlike the \configdirective{Dir Addresses} specification noted above, this
directive only permits a single address to be specified.  This directive
should not be used if you specify a \configdirective{Dir Addresses} (N.B. plural) directive.
}


% failed to use xdirective here, because of verbatim including {}
\directive{dir}{Dir Addresses}{IP-address-specification}{}{}{}%
\index[dir]{Address}%
...
Please note that if you use the \configdirective{Dir Addresses} directive, you must
not use either a \configdirective{Dir Port} or a \configdirective{Dir Address} directive in the same
resource.


\xdirective{dir}{Dir Port}{port-number}{}{9101}{}{%
...
directive should not be used if you specify \configdirective{Dir Addresses} (N.B plural)
directive.
}


\xdirective{dir}{Dir Source Address}{IP-address}{}{}{}{%
...
\xdirective{dir}{FD Connect Timeout}{time}{}{180}{}{%
...
\xdirective{dir}{Heartbeat Interval}{time-interval}{}{0}{}{%
...
\xdirective{dir}{Key Encryption Key}{keyEncryptionKey}{}{}{}{%
...
\xdirective{dir}{Maximum Concurrent Jobs}{number}{}{1}{}{%
\label{DirMaxConJobs}%
...
\xdirective{dir}{Maximum Console Connections}{number}{}{20}{}{%
...
\xdirective{dir}{Messages}{messages-resource-name}{required}{}{}{%
...
\xdirective{dir}{NDMP Snooping}{yes {\textbar} no}{}{}{13.2}{%
\index[general]{NDMP!Snooping}%
This directive enables the Snooping and pretty printing of NDMP protocol
information in debugging mode.
}

\xdirective{dir}{NDMP Loglevel}{number}{}{4}{13.2}{%
\index[general]{NDMP!Logging}%
This directive sets the loglevel for the NDMP protocol library.
}


\xdirective{dir}{Omit Defaults}{yes {\textbar} no}{}{yes}{}{%
}


\xdirective{dir}{Optimize For Size}{yes {\textbar} no}{}{no}{}{%
...
\xdirective{dir}{Optimize For Speed}{yes {\textbar} no}{}{no}{}{%
...
hardlinks in memory. Its relates to the \configdirective{Optimize For Size} option set either
one to \parameter{yes} as they are mutually exclusive.
}


\xdirective{dir}{Plugin Directory}{directory}{}{}{14.2}{%
...
\directive{dir}{Plugin Names}{stringlist}{}{}{14.2}%{%
...
Multiple plugins are separated by \textbf{:}.

Only the basename is given, the file extension \path|-dir.so| is added automatically.
...
\xdirective{dir}{Pid Directory}{directory}{}{{\it platform specific}}{}{%
...
\xdirective{dir}{Query File}{path}{required}{}{}{%
...
\xdirective{dir}{Scripts Directory}{directory}{}{{\it platform specific}}{}{%
This directive is currently unused.
}


\xdirective{dir}{SD Connect Timeout}{time}{}{1800}{}{%
where \parameter{time} is the time that the Director should continue
...
\xdirective{dir}{Statistics Collect Interval}{time-interval}{}{150}{14.2}{%
}


\xdirective{dir}{Statistics Retention}{time}{}{160704000 (5 years)}{}{%
...
\xdirective{dir}{Subscriptions}{number}{}{0}{12.4.4}{%
...
\xdirective{dir}{Subsysdirectory}{directory}{}{}{}{%
}


\xdirective{dir}{TLS \ldots}{\ldots}{}{}{}{%
Bareos can be configured to encrypt all its network traffic.
See chapter \ilink{TLS Configuration Directives}{TlsDirectives} to see,
how the Bareos Director (and the other components) must be configured to use TLS.
}


\xdirective{dir}{VerId}{string}{}{{\it plattform specific}}{}{%
...
\xdirective{dir}{Working Directory}{directory}{}{{\it platform specific}}{}{%
This directive is optional and specifies a directory in which the Director
...
\xdirective{dir}{Pool Type}{backup \textbar \ldots}{}{}{}{%
...
\xdirective{dir}{Storage}{storage-resource-name}{}{}{}{%
The Storage directive defines the name of the storage services where you
want to backup the FileSet data.  For additional details, see the
\ilink{Storage Resource chapter}{StorageResource2} of this manual.
...
\xdirective{dir}{Minimum Block Size}{size-in-bytes}{}{}{14.2}{%
...
\xdirective{dir}{Maximum Block Size}{size-in-bytes}{}{}{14.2}{%
...
\xdirective{dir}{Maximum Volumes}{number}{}{0 (no limit)}{}{%
\label{MaxVolumes}%
...
\xdirective{dir}{Maximum Volume Jobs}{number}{}{0 (no limit)}{}{%
...
\xdirective{dir}{Maximum Volume Files}{number}{}{0 (no limit)}{}{%
...
\xdirective{dir}{Maximum Volume Bytes}{number}{}{0 (no limit)}{}{%
...
\xdirective{dir}{Auto Prune}{yes{\textbar}no}{}{yes}{}{%
\label{PoolAutoPrune}%
...
\xdirective{dir}{Volume Retention}{time-period-specification}{}{365 days}{}{%
\label{VolRetention}
...
\xdirective{dir}{Use Volume Once}{yes{\textbar}no}{}{no}{deprecated}{%
