...
\TODO{missing link: \ilink{Bareos Utility Programs}{bextract}} chapter of this manual. We
...
\TODO{right? {\bf /tmp/bareos-restores}}.  You may modify any of these defaults when the
...
See \TODO{missinge link: \ilink{FileRegex option}{FileRegex}} and below for more details on this.
...
\TODO{relevant? if yes, fix example}
...
\TODO{relevant? move to subsection?}
...
\TODO{relevant? move to appendix}
...
\TODO{move to Desaster Recovery Section?}
...
\item [Solution without a Job Listing]
   ...
   Either you use the \TODO{missing link: \ilink{bscan}{bscan}} program to scan the contents
