...
\subsection{\bareosDir: Configure NDMP Client Resource}
...
\subsection{\bareosSd: Configure NDMP}
...
\subsection{\bareosDir: Configure a Paired Storage}
...
\subsection{\bareosDir: Configure NDMP Fileset}
...
\subsection{\bareosDir: Configure NDMP Jobs}
...
\subsubsection{NDMP Backup Level}
...
To be able to do copy jobs, we need to have a second storage where we can copy the data to.
