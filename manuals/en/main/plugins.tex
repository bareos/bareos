...
\index[general]{Plugin!ceph}
\index[general]{Ceph!Plugin}
...
The package \package{bareos-filedaemon-ceph-plugin} (\sinceVersion{Fd}{CEPH Plugin}{15.2.0}) contains an example configuration file, that must be adapted to your envirnoment.
