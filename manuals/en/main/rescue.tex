...
\warning{Currently the Bareos client name (name of the file daemon resource)
must start with the hostname of the system. This requirement will likely
be removed in the future.}

In our example we use \host{linux} as a
hostname and \parameter{linux-fd} as a Bareos client name.
...
for details
(\elink{http://relax-and-recover.org/documentation/}{http://relax-and-recover.org/documentation/}).
