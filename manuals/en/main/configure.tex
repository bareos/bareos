...
\shortstack[l]{Configuration Directory \\ (default path on Unix) \\ since Bareos $>=$ 16.2.2} \\
\hline
\hline
...
\subsection{Configuration Subdirectories}
...
\subsubsection{Reason for Configuration Subdirectories}
...
\subsubsection{Using configuration subdirectories}

\paragraph{New installation}

\begin{itemize}
    \item Configuration subdirectories are used by default from Bareos \sinceVersion{}{Configuration Subdirectories}{16.2.4} onwards.
...
\begin{itemize}
\item When updating to a Bareos version containing configuration subdirectories,
...
The following image illustrates what names/passwords in which files/Resources
must match up:
