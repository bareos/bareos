...
add [pool={\textless}pool-name{\textgreater} storage={\textless}storage{\textgreater}
...
cancel [jobid={\textless}number{\textgreater} job={\textless}job-name{\textgreater}
  ujobid={\textless}unique-jobid{\textgreater}]
...
\item [create]
   ...
   The full form of this command is:
create [pool={\textless}pool-name{\textgreater}]
...
export storage={\textless}storage-name{\textgreater} srcslots={\textless}slot-selection{\textgreater}
  [ dstslots={\textless}slot-selection{\textgreater} volume={\textless}volume-name{\textgreater} scan ]
...
import storage={\textless}storage-name{\textgreater} [ srcslots={\textless}slot-selection{\textgreater}
  dstslots={\textless}slot-selection{\textgreater} volume={\textless}volume-name{\textgreater} scan ]
...
unmount storage={\textless}storage-name{\textgreater} [drive={\textless}num{\textgreater}]

unmount [jobid={\textless}id{\textgreater} {\textbar} job={\textless}job-name{\textgreater}]
...
use [catalog={\textless}catalog{\textgreater}]
...
wait [jobid={\textless}jobid{\textgreater}] [jobuid={\textless}unique id{\textgreater}]
  [job={\textless}job name{\textgreater}]
