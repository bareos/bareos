...
\TODO{still true for Bareos? If yes, optimize the code}
...
\item [Minimum block size = {\textless}size-in-bytes{\textgreater}] \hfill \\
...
directive, and if you do so, it will be to make Bareos use fixed block
...
\item [Maximum block size = {\textless}size-in-bytes{\textgreater}] \hfill \\
