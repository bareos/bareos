...
To check for warnings, :program:`touch` all source RST files
...
For this reason, any mispelled directives will not be shown at all (and does not even display a warning).

Similar thing happen, is a space is forgotten or a space or line break too many is used.
