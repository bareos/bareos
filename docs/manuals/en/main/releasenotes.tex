...
\begin{itemize}
   ...
   \end{itemize}
   \item HP-UX: build on current HP-UX 11.31
   \item AIX: make client buildable and added spec file
   ...
   \item \ticket{967} Windows: call DeleteFileW and RemoveDirectoryW to be able to remove symlinks before restore
\end{itemize}
