...
\begin{itemize}
    \item added platforms: \os{Fedora}{27}, \os{Fedora}{28}, \os{Univention}{4.3} and \os{openSUSE}{15.0}.
    ...
    \item preparation for \postgresql 10.
    \item fixes a problem of restoring more files then selected.
\end{itemize}
