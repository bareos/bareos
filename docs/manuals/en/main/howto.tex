...
\section{Enable Statistics Collection}
\label{StatisticCollection}

Statistics Collection needs to be enabled by directives of the following resources.
...
\begin{itemize}
  ...
  \item \linkResoruceDirective{Sd}{Storage}{Statistics Collect Interval}
\end{itemize}
