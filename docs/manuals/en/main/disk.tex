...
Assuming you have the appropriate \resourcetype{Dir}{Storage} resource in your Director's
...
\linkResourceDirective{Sd}{Device}{Label Media} = yes to the \resourcetype{Sd}{Device} resource as follows:
