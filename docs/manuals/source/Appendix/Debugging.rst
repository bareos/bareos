...
.. Note:: If you want to debug only a specific daemon, you have to install only its related **-debuginfo** packages. For example with |fd|
...
.. code-block:: shell-session
   ...
   dnf debuginfo-install gdb bareos-debuginfo bareos-filedaemon-debuginfo bareos-filedaemon-python3-plugin-debuginfo bareos-common-debuginfo bareos-debugsource


.. code-block:: shell-session
   :caption: Installing |fd| debug symbols on (open)SUSE system

   zypper --plus-content bareos-debuginfo --plus-content bareos-debugsource install gdb bareos-debuginfo bareos-filedaemon-debuginfo bareos-filedaemon-python3-plugin-debuginfo bareos-common-debuginfo bareos-debugsource
