...
.. figure:: /include/autogenerated/bareos-supported-versions-timeline.svg
   :width: 100%
   :alt: Timeline of supported Bareos major versions
   :class: supported-versions-timeline

   Bareos support timeline generated from the documented support policy and
   major release data. Future majors shown to the right of the current date are
   projections based on the configured release cadence.
