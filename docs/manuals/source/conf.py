...
html_js_files = ["supported-versions-timeline.js"]
...
subprocess.check_call(
    [
        sys.executable,
        "scripts/generate-supported-versions-timeline.py",
        "--input",
        "source/data/bareos-supported-versions.json",
        "--output",
        "source/include/autogenerated/bareos-supported-versions-timeline.svg",
    ]
)
