...
#ifndef __DROPLETS_PROFILE_H__
#define __DROPLETS_PROFILE_H__ 1

/* PROTO droplets_profile.c */
/* src/droplets_profile.c */
...
dpl_status_t dpl_profile_load(dpl_ctx_t *ctx, char *droplets_dir, char *profile_name);
