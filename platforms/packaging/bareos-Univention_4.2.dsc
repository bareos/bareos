...
Build-Depends: acl-dev, autotools-dev, bc, chrpath, dh-systemd, debhelper (>= 7.0.50~), dpkg-dev (>= 1.13.19), git-core, init-system-helpers, libacl1-dev, libcap-dev, libcmocka-dev (>= 1.0.1), libfastlz-dev, libjansson-dev, liblzo2-dev, libqt4-dev, libreadline-dev, libssl-dev, libwrap0-dev, libx11-dev, libsqlite3-dev, libmysqlclient-dev, libpq-dev, logrotate, lsb-release, mtx, ncurses-dev, openssl, pkg-config, po-debconf (>= 0.8.2), python-dev, systemd, ucslint, univention-config-dev, wget, zlib1g-dev
