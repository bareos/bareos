...
!define MUI_ICON   "core/platforms/win32/bareos.ico"
!define MUI_UNICON "core/platforms/win32/bareos.ico"
...
SectionIn 1 2 3 4
  ...
  SetOutPath "$INSTDIR"
  !cd "${SRCDIR}"
  File  core/platforms/win32\bareos-config-deploy.bat
  #!cd "$BINDIR"
  File  core/src/filed/${CONFIG_TYPE}/bareos-fd.exe
